package com.tms.common.constant;
...
public class ErrorId {
    ...
    public static final String REQUIRED_AT_LEAST_TWO_ATL_DATA = "a5001";
    /**
     * Invalid jwt token.
     */
    ...
    public static final String USER_ID_REQUIRED = "uir001";
    ...
    public static final String PART_INVOICE_EXISTS = "pi0001";
    public static final String CURRENCY_CODE_MUST_NOT_BE_EMPTY = "cur002";
    ...
    public static final String LOCATION_ID_ALREADY_EXISTS = "al_101";
    ...
    public static final String ONE_MONTH_DATE_RANGE_LIMIT_ERROR = "dat102";
    ...
    public static final String DATE_RANGE_LIMIT_EXCEED_FOR_1_MONTH = "dat1007";
    public static final String INVALID_TO_DATE = "dat1005";

    public static final String INVALID_DATE_FORMAT = "dat1006";
    ...
    public static final String NO_DATA_AVAILABLE_FOR_THIS_BACKDATE = "ab101";
    ...
    public static final String ALPHABET_NOT_REQUIRED_FOR_VOID_OR_NIL_TYPE = "aml1009";
    public static final String PART_ORDER_NOT_MATCHED = "po101";
    public static final String VENDOR_QUOTATION_NOT_MATCHED = "po105";
    public static final String APPROVAL_SETTINGS_ALREADY_EXISTS = "approval001";
    public static final String PART_ORDER_ID_IS_REQUIRED_FOR_LOGISTIC_MANUAL_PO = "po106";
    public static final String VENDOR_MUST_NOT_BE_DUPLICATE = "vendor_dup";
    public static final String VENDOR_MUST_NOT_BE_DUPLICATE_UNDER_SAME_RFQ = "vendor_dup_1";
    public static final String PAYMENT_CURRENCY_PAYMENT_MODE_MANDATORY = "pi0002";
    /**
    ...
    /**
     * AML Book is already exists
     */
    public static final String AML_BOOK_NO_IS_ALREADY_EXISTS = "aml_book_04";
    /**
     ...
     */
    public static final String NON_NULL_FLIGHT_DATA_DTO = "fd2010";
    /**
    ...
    public static final String APPROVAL_REMARK_CAN_NOT_BE_EMPTY = "ad001";
    ...
    public static final String ENGINE_INCIDENTS_ENUM_ERROR = "lluer-2";
    public static final String INCIDENT_TYPE_ENUM_ERROR = "inct-1";

    public static final String CLASSIFICATION_TYPE_ENUM_ERROR = "clt-1";
    /**
    ...
    public static final String DUPLICATE_AVAILABLE_AIRCRAFT_APUS_FOUND = "apu1005";

    public static final String THIS_AIRCRAFT_HAS_NO_APU = "apu1004";

    public static final String NO_AIRCRAFT_APUS_RECORD_FOUND = "apu1003";
    ...
    /**
     * Invalid Incidents date. Incidents date must be equal or less than current date
     */
    public static final String INVALID_INCIDENTS_DATE = "inc4011";

    public static final String INVALID_INCIDENTS_CLASSIFICATION = "inc4012";
    ...
    public static final String INVALID_DEFECT_TYPE = "defect101";


    public static final String INVALID_FLIGHT_DATA_DTO = "fd2007";
    public static final String LOCATION_TAG_IS_REQUIRED = "ab1007";

    public static final String EMAIL_SENT_FAILED = "email1001";

    public static final String AML_DATA_NOT_SAVED_DUE_TO_FLIGHT_DATA = "amlfl101";

    public static final String AML_REMOVED_DUE_TO_INVALID_FLIGHT_DATA = "amlfl102";

    public static final String FLIGHT_NOT_FOUND_BY_THIS_AML = "amlfl103";

    public static final String RETURN_PART_QUANTITY_MUST_BE_ONE = "srp001";

    public static final String PLANNING_PART_RETURN_FAIL = "ppr001";
    public static final String APPROVED_QUANTITY_IS_NOT_GREATER_THEN_REQUESTED_QUANTITY = "pa001";
}
